...
<qgis version="2.4.0-Chugiak" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <edittypes>
    <edittype labelontop="0" editable="1" name="Element"/>
    <edittype labelontop="0" editable="1" name="Elementnavn"/>
    <edittype labelontop="0" editable="1" name="Underelement"/>
    <edittype labelontop="0" editable="1" name="VedlNiveau"/>
    <edittype labelontop="0" editable="1" name="Arealtype"/>
    <edittype labelontop="0" editable="1" name="ArbejdsstedNr"/>
    <edittype labelontop="0" editable="1" name="areal"/>
  </edittypes>
  <editform></editform>
